...
class AgentSkill(BaseModel):
    # Unique identifier for the skill (e.g., "provide_material_availability")
    id: str

    # Human-readable name for the skill (e.g., "Provide Current Material Availability")
    name: str

    # Optional description to help users understand what the skill does
    description: str | None = None

    # Optional tags to help categorize or search for the skill (e.g., ["material_availability", "machine_states"])
...
class AgentCard(BaseModel):
    # Human-readable name of the agent (e.g., "Material Availability Agent")
    name: str
