# agents/orchestrator_agent/agent_connect.py
# =========================================================
...
class AgentConnector:
    ...
    def __init__(self, name: str, base_url: str):
        ...
        Args:
            name (str): Identifier for the agent (e.g., "EquipmentMonitoringAgent").
    ...
    async def send_task(self, message: str, session_id: str) -> Task:
        ...
        Args:
            message (str): What you want the agent to do (e.g., "What is the material and equipment availability").
        ...
        payload = {
            ...
            "message": {
                ...
                "parts": [
                    {"type": "text", "text": message}  # Wrap the text in a list of parts
                ],
            },
        }
